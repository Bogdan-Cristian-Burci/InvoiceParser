#!/usr/bin/env python3
"""
Test script to verify product grouping per delivery functionality.
"""
import sys
import os
...
def test_product_grouping():
    ...
    print("=== TESTING PRODUCT GROUPING PER DELIVERY ===")
    ...
    output_file = '/Users/bogdancristianburci/Herd/InvoiceScan/python-parser/test_results.json'
